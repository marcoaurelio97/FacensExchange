...
(18, 'md5', 'md5@gmail.com', '1bc29b36f623ba82aaf6724fd3b16718'),
(19, 'a', 'a@a', '0cc175b9c0f1b6a831c399e269772661'),
(20, 'gui', 'gui@gui', 'c00425797de3c98e7b32e814b54a6ec5'),
(21, 'augustinhogui', 'augusto@guilherme', 'c4ca4238a0b923820dcc509a6f75849b'),
(24, 'David_Oliveira', 'dluan.oliveira1@gmail.com', '202cb962ac59075b964b07152d234b70'),
(25, '231', '321@gmail.com', 'caf1a3dfb505ffed0d024130f58c5cfa'),
(26, 'b', 'b@b', '92eb5ffee6ae2fec3ad71c777531578f'),
(27, 'David Oliveira ', 'd123@gmailml.com', '26c8b044ee0b58dbd63f0162b5a6d52d'),
(28, 'David', 'd@hotmail.com', '202cb962ac59075b964b07152d234b70'),
(29, 'markinho', 'marco_aureliog@hotmail.com', '202cb962ac59075b964b07152d234b70'),
(30, 'tteste', 'tteste@gmail.com', '202cb962ac59075b964b07152d234b70'),
(31, 'loucura', 'loucura@louca', '81dc9bdb52d04dc20036dbd8313ed055'),
(32, 'marco.montebello', 'marco.montebello@facens.br', '202cb962ac59075b964b07152d234b70'),
(33, 'testeaula', 'testeaula@gmail.com', '202cb962ac59075b964b07152d234b70'),
(34, 'teste10', 'teste10@gmail.com', '202cb962ac59075b964b07152d234b70');
...
ALTER TABLE `amizade`
  ...
  ADD KEY `fk_amizade_usuarios` (`id_usuario`);
...
ALTER TABLE `perfil`
  ...
  ADD KEY `fk_perfil_usuarios` (`id_usuario`),
  ADD KEY `fk_perfil_pais` (`id_pais`),
  ADD KEY `fk_perfil_cidade` (`id_cidade`),
  ADD KEY `fk_perfil_estado` (`id_estado`),
  ADD KEY `fk_perfil_curso` (`id_curso`),
  ADD KEY `fk_perfil_semestre` (`id_semestre`),
  ADD KEY `fk_perfil_imgperfil` (`id_img_perfil`);
...
ALTER TABLE `resposta_convite`
  ...
  ADD KEY `fk_resposta_convite` (`id_usuario`);
...
--
ALTER TABLE `convite`
  ADD CONSTRAINT `fk_convite_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`);

--
-- Limitadores para a tabela `perfil`
--
ALTER TABLE `perfil`
  ADD CONSTRAINT `fk_perfil_cidade` FOREIGN KEY (`id_cidade`) REFERENCES `cidade` (`CT_ID`),
  ADD CONSTRAINT `fk_perfil_curso` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id_curso`),
  ADD CONSTRAINT `fk_perfil_estado` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`UF_ID`),
  ADD CONSTRAINT `fk_perfil_imgperfil` FOREIGN KEY (`id_img_perfil`) REFERENCES `img_perfil` (`id_img_perfil`),
  ADD CONSTRAINT `fk_perfil_pais` FOREIGN KEY (`id_pais`) REFERENCES `pais` (`SL_ID`),
  ADD CONSTRAINT `fk_perfil_semestre` FOREIGN KEY (`id_semestre`) REFERENCES `semestre` (`id_semestre`),
  ADD CONSTRAINT `fk_perfil_usuarios` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`);

--
-- Limitadores para a tabela `post`
--
ALTER TABLE `post`
  ADD CONSTRAINT `fk_post_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`);

--
-- Limitadores para a tabela `resposta_convite`
--
ALTER TABLE `resposta_convite`
  ADD CONSTRAINT `fk_resposta_convite` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`);
COMMIT;
