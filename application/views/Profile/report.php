                        ...
                        <form action="" method="post" enctype="multipart/form-data">                
                            <div class="box-body">
                                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <strong><i class="fa fa-edit margin-r-5"></i>Username</strong>
                                    <input type="text" class="form-control" name="title" id="title" value="<?php echo $profile->user_username ?>" required readonly>
                                    </div>
                                    <div class="form-group">
